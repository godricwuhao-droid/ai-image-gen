...
| 项目           | 说明                            |
| :----------- | :---------------------------- |
| 端点           | `POST /v3/gpt-image-2-text-to-image` |
| 认证           | Bearer Token                  |
...
| output\_format      | string  |    png    |  否  | 输出文件格式                  |
| output\_compression | integer |     -     |  否  | 压缩等级（0-100），仅 JPEG 有效   |
...
| image          | string  |     -     |  是  | 要编辑的图片（URL/base64/数组，支持多图融合）   |
